...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="../../assets/css/estilosCertificadoSSL.css">
    ...
    <main>
      <section id="seccion1">
        <div class="filaseccion1">
            <img src="../../resources/sec1.png" alt="">
        </div>
          <div class="fila1seccion1">
            <div class="shield">
              <p class="text"> CERTIFICADOS SSL PARA </p>
              <p class="text"> TU SITIO AHORA </p>
            <img src="../../resources/shield.png" alt="">
            <button type="button" name="button"> COMPRAR </button>
            <p> Brinda la mejor seguridad a tus clientes en tu sitio 
                contamos con los mejores certificados</p>
          </div>
          </div>
        </div>
      </section>
      <section id="seccion2">
        <div class="info">
          <p> <a>REGISTRATE</a> COMPRA Y ASEGURA TU SITIO O <a>INICIA SESION</a> PARA IR A TU AREA DE CLIENTE Y COMPRA AHORA </p>
        </div>
      </section>
      <section id="seccion2-1"></section>
      <section id="seccion3">
          <div class="filaseccion3">
      ...
      <section id="seccion4">
        <div class="texto">
          <p>HOY EN DIA <br/> LA MAYORIA <br/> DE LAS APLICACIONES
             WEB <br/> Y SERVIDORES SOPORTAN UN <br/> CERTIFICADO SSL
             POR ESO ES POR QUE <br/> LE RECOMENDAMOS TENER UNO <br/>
             ASEGURA A TUS CLIENTES <br/> A LA HORA DE COMPRAR <br/>
             O INCLUSO AL NAVEGAR <br/> EN TU SITIO</p>
        </div>
        </hr>
        <div class="grid">
          <div class="box_a"></div>
          <div class="box_b">
            ...
            <p> CERTIFICADO SSL </p> <p> 1 AÑO </p> <p> $$$/MES </p> <button type="button" name="button">CONTRATAR</button>
          </div>
          <div class="box_c"></div>
          <div class="box_d"></div>
          <div class="box_e"></div>
