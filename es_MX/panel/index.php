...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/rowgroup/1.0.0/css/rowGroup.semanticui.min.css">
      ...
      <div class="cabeceraCuerpo">
        <div class="ui text menu iconosCabecera">
          ...
          <a class="item iconoDos">
            <i class="shop icon"></i>
            <div class="floating ui red mini circular label" id="contadorCarrito">22</div>
          </a>
        </div>
