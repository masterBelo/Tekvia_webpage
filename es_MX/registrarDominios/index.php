...
<html>
  ...
  <head>
    ...
    <title>Registrar dominios</title>
  </head>
  <div id="preloader">
    <div id="container">
  ...
  <body>
        ...
        <div class="contenedorOpciones">
          ...
          <div class="dropdown part1Opc3">
            ...
            <div class="dropdowncontent" id="dropdownIdioma">
             <a href="../../en_UK/registrarDominios/">
    ...
    <main>
      <section id="buscadorDominiosRegistro">
        <div class="filaBuscador1">
          <div class="filaBuscador1Columna1">
            <p>Registra tu dominio ahora y
              haz que tu negocio llegue a mas clientes</p>
            <div class="inputBuscadorDominiosRegistro">
                <form method="post" action="../comprarDominio/index.php">
              <input type="text" name="dominio" value="" placeholder="¿Que dominio buscas?">
              <img src="../../resources/lupaRegistroDominios.png" alt="">
                </form>
            </div>
          </div>
          <div class="filaBuscador1Columna2">
            <img src="../../resources/computadoraRegistroDominios.png" alt="">
          </div>
        </div>
        <div class="filaBuscador2">
          <button type="button" name="button">AYUDA</button>
        </div>
      </section>
      <section id="infoIDominiosRegistro">
        <div class="filaBuscador1">
          <div class="filaBuscador1Columna1">
            <img src="../../resources/tekviaword.png" alt="">
          </div>
          <div class="filaBuscador1Columna2">
            <div class="title">
            <p>Registra tu dominio ahora y haz que tu negocio llegue a mas clientes</p>
          </div>
          <div class="text">
            <p>El registro de dominios es el primer paso fundamental para iniciar
              cualquier cosa en Internet, desde la creación de un Sitio Web o tienda en línea,
              hasta el envío y la recepción de correos.</p>
            <p>Personas y empresas de todo el mundo utilizan los dominios
              para posicionar sus marcas y lograr una identidad en Internet. </p>
            </div>
          </div>
         </div>
        </div>
      </section>
      <section id="infoIIDominiosRegistro">
        <div class="filaBuscador1">
          <div class="filaBuscador1Columna1">
            <div class="title">
            <p>Tus clientes están buscándote en internet</p>
          </div>
          <div class="text">
            <p>Con más de 2,400 millones de usuarios de internet en el mundo y una penetración
               que crece exponencialmente, pasar inadvertido ante ese inmenso mercado no es una
               opcion a conciderar.</p>
            <p>Los Dominios son sinónimo de negocios sin fronteras. </p>
          </div>
          </div>
          <div class="filaBuscador1Columna2">
