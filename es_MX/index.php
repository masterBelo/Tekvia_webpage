            ...
            <div class="itemSlider">
              <div class="infoItem" id="item1">
                ...
                <div class="columnaInfo2">
                  <span class="tituloItemInfo">Tu empresa comienza con un nombre</span>
                  <span class="textoItemInfo">Consigue tu nombre en internet</span>
                  <button type="button" name="button">BUSCA EL TUYO</button>
                </div>
              </div>
            </div>
            <div class="itemSlider">
              <div class="infoItem" id="item2">
                ...
                <div class="columnaInfo1">
                  ...
                  <span class="textoItemInfo">Los servidores mas poderosos que encontraras. Revisa nuestros planes.</span>
                  <button type="button" name="button">VER PLANES</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="infoInicio">
          <div class="info1">
            <div class="busquedaDominio">
              <div class="buscador">
                <input type="text" name="" value="" placeholder="¿QUE DOMINIO BUSCAS?">
                <div class="flecha">
            ...
            <div class="hostingPrecio">
              ...
              <div class="textoHostingPrecio">
                ...
                <div class="linea3">
                  Pesos mexicanos, el plan esta sujeto a cambios dependiendo el uso.
                </div>
              </div>
            </div>
          </div>
          <div class="info2">
            ¿Nececitas asesoria? <button type="button" name="button">CHAT </button> o llama ahora al (33)1598 2616
          </div>
          <div class="info3">
            <div class="infoCloud">
              <div class="textoCloud">
                ...
                <div class="linea2" data-aos="fade-right">
                  <p>Lleva tu negocio a cualquier parte del mundo y llega a millones
                    de clientes con tan solo un click contrata ahora tu paquete
                    de web hosting todo ilimitado y disfruta de una experiencia con las
                    herramientas que tekvia te ofrece. </p>
                </div>
                <div class="linea3">
                  <button type="button" class="btn btn-chido raised">COMPRAR</button>
                </div>
              </div>
            </div>
          ...
          <div class="info4">
            ...
            <div class="infoServer" data-aos="zoom-in-down">
              <div class="textoServer">
                ...
                <div class="linea2">
                  <p>Disfruta de la maxima potencia de un cloud server y lleva tu
                    proyecto o aplicacion movil a un segundo nivel.</p>
                </div>
                <div class="linea3">
                  <button type="button" class="btn btn-chido raised">COMPRAR</button>
                </div>
