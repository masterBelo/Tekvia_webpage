...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="../../assets/css/estilosCloudhost.css">
  ...
  <body>
    ...
    <main>
      <section id="seccion1">
        <div class="columna1">
          <div class="fila1">
            <img src="../../resources/whitcloud.png">
          </div>
          <div class="fila2">
            <p> CLOUD HOSTING </P>
          </div>
          <div class="fila3">
            <p> Nuestro servicio de almacenamiento SSD cuenta con la </br>
              velocidad para cualquier proyecto que tengas en mente. </P>
          </div>
          <div class="fila4">
            <p> INICIA TUS IDEAS AL INSTANTE </P>
          </div>
        </div>
        <div class="columna2">
      ...
      <section id="seccion2">
        <div class="fila1">
            <p> ADOPTA TU CLOUD SERVER A TUS NECESIDADES  </P>
        </div>
        <div class="fila2">
          <img src="../../resources/servers.png">
        </div>
        <div class="fila3">
          <p> CONFIGURA EN WIMNDOWS O LUNUX SOLO ELIGE </P>
        </div>
      </section>
      <section id="seccion3">
        <div class="fila1">
            <p> CONFIGURA AHORA NO ESPERES MAS </p>
        </div>
        <div class="fila2">
        <div class="grid">
          <div class="box_a">
            <img src="../../resources/20GB.png">
              <p> $$$$ </br> /MES</p>
          </div>
          <div class="box_b">
              <button type="button" name="button"> COMPRAR </button>
      ...
      <section id="seccion4">
        <button type="button" style="button">COMPRAR</button>
        <P> SOPORTE 24X7X365 DIAS TU SITIO SIEMPRE EN LINEA</P>
      </section>
    </main>
    <footer>
        <section class="part1">
