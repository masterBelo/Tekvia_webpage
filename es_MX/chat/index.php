...
<html>
  ...
  <body>
    ...
    <main>
     <section class="cabeceraChat" data-aos="fade-left">
        <div class="textoChat">
            <h3 class="textoChat1">VIVE UNA MEJOR EXPERIENCIA<br> CON TUS CLIENTES</h3><br>
            <h4 class="textoChat2">ASESORIA EN EL MOMENTO</h4>
            <a href="#"><h5 class="textoChat3">CONSULTAR PRECIOS</h5></a>
         </div>
         <div class="imgChat">
         <img class="imgChat2" src="../../resources/celChat.png">
         </div>
        </section>
        <section class="chat2" data-aos="fade-right">
            <div class="espacioChat">
                <a href="../login/index.php"><font class="chatVerde">Registrate </font></a><font class="chatAzul">compra y NOSOTROS NOS ENCARGAMOS o </font><a href="../login/index.php"><font class="chatVerde">inicia sesión</font></a><br><font class="chatAzul">para ir a tu area de clientes y comprar ahora.</font>
            </div>
        </section>
        <section class="iniciarChat" data-aos="fade-left">
            <img class="iniciarChat2" src="../../resources/iniciarChat.png">
        </section>
        <section class="mastxChat" data-aos="fade-right">
            <font class="chatAzul">El Chat de Asistencia en línea </font><font class="chatGris txtChico">es una herramienta de gran efectividad<br>para generar confianza, cerrar más ventas y convertir a tus clientes<br>en fans de tu marca </font><font class="chatNaranja">brindándoles respuestas inmediatas y en tiempo<br>real a sus consultas</font><br><br>
            <img class="asistenciaChat" src="../../resources/asistenciaChat.png">
        </section>
        <section class="finalChat" data-aos="fade-left">
            <div class="chatContainer">
                <div class="chat150"><img class="solaChat" src="../../resources/150Chat.png"><br><a href="#"><img class="solaBtn" src="../../resources/btnChat.png"></a></div>
                <div class="chat380"><img class="solaChat" src="../../resources/380Chat.png"><a href="#"><img class="solaBtn" src="../../resources/btnChat.png"></a></div>
                <div class="chat499"><img class="solaChat" src="../../resources/499Chat.png"><a href="#"><img class="solaBtn" src="../../resources/btnChat.png"></a></div>
            </div>
            <div class="finalChatTxt">PRECIOS EN PESOS MEXICANOS IVA INCLUIDO</div>
        </section>
    </main>
    <footer>
        <section class="part1">
