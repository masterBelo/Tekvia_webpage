    ...
    <main>
      ...
      <div class="fila1seccion1">
          <div class="shield">
            ...
            <p class="textII"> LA MEJOR SOLUCION PARA ALOJAR TU WEB </p>
            <img src="../../resources/za-wardo.png" alt="">
            <p class="textIII"> QUE ESPERAS PARA HOSPEDAR TU WEB CON NOSOTROS </p>
            <button type="button" name="button"> COMPRAR </button>
          </div>
      </div>
      </section>
      <section id="seccion2">
          <img src="../../resources/123.png" alt="">
      </section>
      <section id="seccion2-1">
        <div class="info">
          <p> <a>REGISTRATE</a> COMPRA Y ASEGURA TU ESPACIO, O <a>INICIA SESION</a> PARA IR A TU AREA DE CLIENTE Y COMPRA AHORA </p>
        </div>
      </section>
      <section id="seccion3">
        <button type="button" name="button"> COMPRAR </button>
      ...
      <section id="seccion4">
        ...
        <div class="columna2">
          <div class="grid">
            ...
            <div class="box_b">
              <p> HAZ QUE TUS CLIENTES </br> LLEGUEN </br> A TU SITIO </p>
            </div>
            <div class="box_c">
              <p> CREA TU TIENDA </br> EN LINEA Y ALOJA </br> CON TEKVIA</p>
            </div>
            <div class="box_d">
            ...
            <div class="box_f">
              <p> VENDE MAS, </br> LLEGA A MAS </br> CLIENTES CON </br> WEB HOSTING </p>
            </div>
          </div>
        </div>
      </section>
