...
<html>
 ...
 $final="no esta disponible";
  ...
  if($rango == 0){
        ...
        echo "<br>";
        echo "$dominio no esta <font class='rojoCD'>Disponible</font> <br><br>";
        echo "<a href='../registrarDominios'><input type='submit' value='Regresar' class='btnCD'></a>";
        echo "</div>";
...
<?php
 if($rango == 1){
        echo "<div class='yesCD'>";
        echo "<br>";
        echo "$dominio esta <font class='verdeCD'>Disponible</font> <br><br>";
        ?>
        <input type="hidden" name="dns" value="<? echo "$dominio"; ?>">
        <?php
        echo "<input type='submit' value='Comprar Ahora' class='btnCD'>";
         } ?>
        </form></div>
    </main>
    <footer>
