    ...
    <main>
     <section class="cabeceraCDN">
        <div class="txtCabeceraCDN">
            <font class="txtCDN1">
SEND THE MAXIMUM TO YOUR WEBSITE</font><br>
            <font class="txtCDN2">EVERYWHERE GIVING ONLY ONE CLICK</font>
         </div>
         <div class="cabeceraAbajoCDN">
         <div class="cabeceraAbajoCDNr">
             <img class="nubeCDN" src="../../resources/nubeCDN.png"><br>
             <input class="btnCDN" type="submit" value="ACTIVATE">
         </div>
        ...
        <div class="txtCuadroCDN">
            <font class="txtCDN3">SEND THE MAXIMUM TO YOUR WEBSITE</font><br><br>
            <font class="txtCDN4">IF YOUR SITE IS THE FASTEST INTERNET<br>THOSE WHO VISIT IT EXPERIENCE A BETTER EXPERIENCE<br>
AND THE SEARCHERS DISTING IT TO FIND IT MORE EASILY</font>
            </div>
            <div class="cuadroCDNI">
            <img class="cuadroCDNimg" src="../../resources/cuadroCDNe.png">
            </div>
        </section>
        <section class="activaCDN">
        <div class="activaCDNc">
        <div class="activaCDNr">
            <font class="activaCDNtxte">ACTIVATES YOUR CDN TODAY</font>
            </div>
        <div class="activaCDNl">
            <input class="activaCDNbtn" type="submit" value="ACTIVATE ">
            </div>
            </div>
        </section>
        <section class="infoCDN">
            <div class="infoCDNt">
            YOUR SITE IS NOT MODIFIED
            </div>
            <div class="txtContainerCDN">
            <div class="txt1CDN">
                <img class="txt1CDNi" src="../../resources/infoCDN1.png"><div class="txt1CDNt">
We implemented the service on your website unmodified<br>Or need special requirements in your code<br>Simply hire and we will do the rest.</div>
                </div>
            <div class="txt2CDN">
                <img class="txt1CDNi" src="../../resources/infoCDN2.png"><div class="txt1CDNt">
In a few minutes you will notice the difference and you will be able to access your site In a faster, safer and better performance.</div>
                </div>
            </div>
        </section>
        <section class="dudasCDN">
            <div class="dudascCDN">
            <div class="dudasCDNr">
                <div class="dudasCDNtxt">YOU HAVE DOUBTS?</div>
                </div>
            <div class="dudasCDNl">
