      ...
      <div class="headerPart1">
        ...
        <div class="contenedorOpciones">
          ...
          <?php
			...
			?>
          <a href="<?php echo $login; ?>" target="_top" class="part1Opc2">LOGIN</a>
          <a href="<?php echo $login; ?>" target="_top" class="part1Opc2">SING UP</a>
          <?php
          }else{
          ?>
    ...
    <main>
        ...
        <section class="formulario">
            ...
            <div class="titulo" data-aos="fade-rigth">
                <p class="titulog">Registration form .edu</p>
                <p class="tituloc">Please fill out the registration form</p>
                </div><p class="titulob">(* Required fields)</p>
            <section class="inputtext" data-aos="fade-rigth">
            <div class="inputtexti">
                *Name of the institution: <input class="inputt" type="text" name="nombreInstitucion" autocomplete="off" required><br><br>
                *RFC: <input class="inputt" type="text" name="rfcInstitucion" autocomplete="off" required><br><br>
                *Address of the institution: <input class="inputt" type="text" name="direccionInstitucion" autocomplete="off" required><br><br>
                ...
                *CP: <input class="inputtc" type="text" name="cpInstitucion" maxlength="5" onkeypress="return justNumbers(event);" autocomplete="off" required> *Cologne/Locality: <input class="inputt" type="text" name="coloniaInstitucion" autocomplete="off" required><br><br>
                *State: <select class="inputts" name="estadoInstitucion" autocomplete="off">
                ...
                </select> *City: <input class="inputt" type="text" name="municipioInstitucion" autocomplete="off" required><br><br><br>
                *Proof of address (light bill, water bill, telephone bill, building code)<br>
                <input type="file" name="comprobanteInstitucion" id="comprobanteInstitucion" class="inputfile" autocomplete="off" required />
                <label for="comprobanteInstitucion" class="lh">SELECT FILE</label>
                </div>
                ...
                *Address of legal representative:<br>
               ...
               <section class="inputarchivos">
                   ...
                   *Please upload the following documents<br>(PDF format)
                   </div>
                   <div class="archivos" data-aos="fade-left">
                    *RFC registration record in force<br>
                    <input type="file" name="cedulaRfcAR" id="cedulaRfcAR" class="inputfile" autocomplete="off" required/>
                <label for="cedulaRfcAR" class="lh">SELECT FILE</label><br><br><br>
                    *Certificate of authorization to the SEP, CONACYT or educational center by the Mexican state<br>
                       <input type="file" name="cedulaAutorizacionAR" id="cedulaAutorizacionAR" class="inputfile" autocomplete="off" required />
                <label for="cedulaAutorizacionAR" class="lh">SELECT FILE</label><br><br><br>
                    *SEP or CONACYT Registration<br>
                       <input type="file" name="registroAR" id="registroAR" class="inputfile" autocomplete="off" required />
                <label for="registroAR" class="lh">SELECT FILE</label><br><br><br>
                    *Copy of the newspaper or official newspaper that accredits it<br>
                       <input type="file" name="copiaAcreditaAR" id="copiaAcreditaAR"class="inputfile" autocomplete="off" required />
                <label for="copiaAcreditaAR" class="lh">SELECT FILE</label><br><br><br>
                    *Copy of current identification of legal representative<br>
                       <input type="file" name="copiaRPAR" id="copiaRPAR" class="inputfile" autocomplete="off" required />
                <label for="copiaRPAR" class="lh">SELECT FILE</label><br><br><br>
                    <div class="mitadRP">
                        <div class="mitadRP1">
                    *Letter from the institution<br>
                            <input type="file" name="cartaMembretadaAR" id="cartaMembretadaAR" class="inputfile" autocomplete="off" required />
                <label for="cartaMembretadaAR" class="lh">SELECT FILE</label><br><br><br>
                            *Power of attorney before notary<br>
                            <input type="file" name="cartaPoderAR" id="cartaPoderAR" class="inputfile" autocomplete="off" required />
                <label for="cartaPoderAR" class="lh">SELECT FILE</label><br><br><br>
                        </div>
                        <div class="mitadRP2">
                            <a href="#"> <div class="botoncitoverde">HELP</div> </a>
                        </div>
                       </div>
                   </div>
    </section>
                <div class="final">
                    ...
                    <input type="submit" value="ENVIAR" class="finalbtn">
                        <div class="finaltxt">We will respond to your request shortly and will be notified in your<br>control panel <a href="#"><font class="verde">login</font></a> to see the progress</div>
