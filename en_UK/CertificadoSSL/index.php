    ...
    <main>
      <section id="seccion1">
        <div class="filaseccion1">
            <img src="../../resources/sec1i.png" alt="">
        </div>
          <div class="fila1seccion1">
            <div class="shield">
              <p class="text"> SSL CERTIFICATES FOR </p>
              <p class="text"> YOUR SITE NOW </p>
            <img src="../../resources/shield.png" alt="">
            <button type="button" name="button"> BUY </button>
            <p> Provide the best security for your customers on your site
                We have the best certificates</p>
          </div>
          </div>
        </div>
      </section>
      <section id="seccion2">
        <div class="info">
          <p> <a>SIGN UP</a> BUY AND SECURE YOUR SITE OR <a>LOGIN</a> TO GO TO YOUR CUSTOMER AREA AND PURCHASE NOW </p>
        </div>
      </section>
      ...
      <section id="seccion4">
        <div class="texto">
          <p>TODAY <br/> THE MOST <br/> WEB APPLICATIONS <br/> AND SERVERS SUPPORT AN <br/> SSL CERTIFICATE THAT IS WHY <br/> WE RECOMMEND YOU TO HAVE ONE <br/>
             SECURE YOUR CLIENTS <br/> AT THE TIME TO BUY <br/>
             OR EVEN WHEN YOU BROWSE <br/> ON YOUR SITE</p>
        </div>
        </hr>
        <div class="grid">
          <div class="box_a"></div>
          <div class="box_b">
            ...
            <p> SSL CERTIFICATE </p> <p> 1 YEAR </p> <p> $$$/MONTH </p> <button type="button" name="button">CONTRACT</button>
          </div>
          <div class="box_c"></div>
          <div class="box_d"></div>
          <div class="box_e"></div>
