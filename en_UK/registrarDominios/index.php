          ...
          <div class="dropdown part1Opc3">
            ...
            <div class="dropdowncontent" id="dropdownIdioma">
             <a href="#">
                ...
                <a href="../../es_MX/registrarDominios/">
              <div class="opcionDrop">
    ...
    <main>
      <section id="buscadorDominiosRegistro">
        <div class="filaBuscador1">
          <div class="filaBuscador1Columna1">
            <p>Register your domain now
                make your business reach more customers</p>
            <div class="inputBuscadorDominiosRegistro">
              <input type="text" name="" value="" placeholder="What domain do you look for?">
      ...
      <section id="infoIDominiosRegistro">
        <div class="filaBuscador1">
          ...
          <div class="filaBuscador1Columna2">
            <div class="title">
            <p>Register your domain now and get your business to more customers</p>
          </div>
          <div class="text">
            <p>Domain registration is the first fundamental step to start
              Anything on the Internet, from the creation of a Web site or online store,
              Until the sending and receiving of mails.</p>
            <p>People and businesses around the world use domains
              To position their brands and achieve an identity on the Internet.</p>
            </div>
          </div>
         </div>
        </div>
      ...
      <section id="infoIIDominiosRegistro">
        <div class="filaBuscador1">
          <div class="filaBuscador1Columna1">
            <div class="title">
            <p>Your customers are looking for you on the internet</p>
          </div>
          <div class="text">
            <p>With more than 2.4 billion Internet users in the world and a penetration
               Which is growing exponentially, to go unnoticed in front of this huge market is not a
             good option</p>
            <p>Domains are synonymous with businesses without borders.</p>
          </div>
          </div>
          <div class="filaBuscador1Columna2">
