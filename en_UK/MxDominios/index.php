...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="../../assets/css/estilosdominoMx.css">


    <title>dominios .MX</title>
  </head>
  <div id="preloader">
    <div id="container">
    ...
    <main>
      <section id="seccion1">
        <div class="filaseccion1">
          <div class="filaseccion1Columna1">
            <p class="title">Get your domain with nationality.</p>
            <p class="text">.com.mx, .mx o .net it's up to you</p>
            <div class="inputseccion1">
              <input type="text" name="" value="" placeholder="Enter your domain">
      ...
      <section id="seccion2">
        <div class="columna1">
          ...
          <p>.com.mx for only $$$ / month ||| .mx or .net for only $$$ / month</p>
        </div>
        <div class="columna2">
            <p class="titulo">Reasons to register a .mx domain</p>
            <p class="texto"> <img src="../../resources/Mexico.svg"/> It is used for geographically located websites in Mexico.</p>
            <p class="texto"> <img src="../../resources/Mexico.svg"/> Your business will associate and identify directly with Mexico, which can help you improve the positioning of your site.</p>
            <p class="texto"> <img src="../../resources/Mexico.svg"/> Your domain will be administered under the consumer protection laws of our country.</p>
            <p class="texto"> <img src="../../resources/Mexico.svg"/> It is a short, simple and easy to remember ending.</p>
        </div>
      </section>
    </main>
    <footer>
