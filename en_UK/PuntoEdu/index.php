    ...
    <main>
      <section id="seccion1">
        <div class="filaseccion1">
          <div class="filaseccion1Columna1">
            <p>.edu</p>
            <p>Register your domain with Tekvia</p>
      ...
      <section id="seccion2">
        ...
        <div class="col-sm-3" style="background-color: #ff9200; height: 500px">
          <div class="fila1">
            <p>ALWAYS AVAILABLE</p><br>
          </div>
          <div class="fila2">
            <p>Your domain available 24x7x365 reaches more places with a single click</p><br><br>
        </div>
        <div class="fila3">
        ...
        <div class="col-sm-3" style="background-color: #ff4f1f; height: 500px">
          ...
          <div class="fila2">
            <p>If your domain is available in less than 24 hours it will be active as long as you complete an application form,
            And the rest leave it to Tekvia.</p><br>
          </div>
          <div class="fila3">
      ...
      <div class="columna3">
        <div class="col-sm-3" style="background-color: #4c4c4c; height: 500px">
         <div class="fila1">
           <p>SAFETY ALWAYS</p><br>
         </div>
         <div class="fila2">
          <p>Accredited by ICCAN, also acquire your hosting plan and enjoy the benefits and tools
            To be able to start your online site all to a click</p><br>
        </div>
        <div class="fila3">
          <img src="resources/tekviahand.png">
        </div>
        <div class="fila4">
          <button>Hosting Plans</button>
        </div>
      </div>
      </div>
      <div class="columna4">
        <div class="col-sm-3" style="background-color: #00b47d; height: 500px">
          ...
          <div class="fila2">
          <p>Our control panel is the most complete, administrates and carries the state your domain without complications
            Register and meet now</p><br>
        </div>
        <div class="fila3">
