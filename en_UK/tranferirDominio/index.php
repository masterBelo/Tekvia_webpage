    ...
    <main>
      <section class="contenidoInicio">
          <div class="transferirDominio">
              <div class="transferirDominio1">
                  <div class="transferirDominioTxt">
                      Transfer your domain now<br>Get a free monthly payment, do not expect more.<br>
          ...
          <div class="transferirDominioAyuda">
              <p class="transferirDominioAyuda1">Do you need advice?</p>
              <p class="transferirDominioAyuda2">or</p>
              <p class="transferirDominioAyuda3">Call Now (33) 1586 2616</p>
          </div>
          <div class="transferirDominio3">
              <div class="transferirDominio31">
                  <div class="transferirDominio3P21">
                      <div class="transferirDominio3P211">
                      <p class="tD22">ALWAYS <font class="comoelmarazul">INFORMED</font></p>
                      <p>With tekvia stay informed in real time, with our customer area, payments, renewals, information of your services, help tekvia, and keep the administration of your site in the palm<br>of your hand.</p>
                      </div>
                  </div>
                  <div class="transferirDominio3P22">
                      <div class="transferirDominio3P221">
                      <p class="tD22">WHY <font class="comoelmarazul">CHANGE</font> TEKVIA?</p>
                      <p>Moving with us will be your best option since all our
                          Servers are in the region, we also have high,
                          Simultaneous monitoring technology where your hosted service is in the
                          Better hands and quality service.</p>
                      </div>
                  </div>
                  <div class="transferirDominio3P23">
                      <div class="transferirDominio3P241">
                        <p class="tD22">DO <font class="comoelmarazul">YOURSELF</font> WITH TEKVIA</p>
                        <p>You do not need help from professionals with tekvia, do it yourself but of course if you have problems, contact an expert and we will gladly help you.</p>
                      </div>
                  </div>
                  <div class="transferirDominio3P24">
                      <div class="transferirDominio3P231">
                        <p class="tD22">ALWAYS <font class="comoelmarazul">PRESENT</font> WITH TEKVIA</p>
                        <p>Let your mark have internet presence we are the best with 24x7 support 365 days of the year, so your customers will <br>stop looking for you, we have the best plan for you.</p>
                      </div>
                  </div>
              </div>
          </div>
