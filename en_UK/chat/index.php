  ...
  <body>
    ...
    <main>
     <section class="cabeceraChat" data-aos="fade-left">
        <div class="textoChat">
            <h3 class="textoChat1">LIVE A BETTER EXPERIENCE WITH<br> YOUR CUSTOMERS</h3><br>
            <h4 class="textoChat2">ADVICE IN THE MOMENT</h4>
            <a href="#"><h5 class="textoChat3">CHECK PRICES</h5></a>
         </div>
         <div class="imgChat">
        ...
        <section class="chat2" data-aos="fade-right">
            <div class="espacioChat">
                <a href="../login/index.php"><font class="chatVerde">Sign up </font></a><font class="chatAzul">buy and WE CHARGE or </font><a href="../login/index.php"><font class="chatVerde">log in </font></a><br><font class="chatAzul">To go to your customer area and buy now.</font>
            </div>
        </section>
        <section class="iniciarChat" data-aos="fade-left">
            <img class="iniciarChat2" src="../../resources/iniciarChate.png">
        </section>
        <section class="mastxChat" data-aos="fade-right">
            <font class="chatAzul">The Online Support Chat </font><font class="chatGris txtChico">is a highly effective tool<br>to build confidence, close more sales and turn your customers<br>into fans of your brand  </font><font class="chatNaranja">by providing immediate and<br>real-time answers to your queries</font><br><br>
            <img class="asistenciaChat" src="../../resources/asistenciaChat.png">
        </section>
        <section class="finalChat" data-aos="fade-left">
            <div class="chatContainer">
                <div class="chat150"><img class="solaChat" src="../../resources/150Chate.png"><br><a href="#"><img class="solaBtn" src="../../resources/btnChate.png"></a></div>
                <div class="chat380"><img class="solaChat" src="../../resources/380Chate.png"><a href="#"><img class="solaBtn" src="../../resources/btnChate.png"></a></div>
                <div class="chat499"><img class="solaChat" src="../../resources/499Chate.png"><a href="#"><img class="solaBtn" src="../../resources/btnChate.png"></a></div>
            </div>
            <div class="finalChatTxt">PRICES IN MEXICAN PESOS IVA INCLUDED</div>
        </section>
    </main>
    <footer>
        <section class="part1">
