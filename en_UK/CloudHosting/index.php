    ...
    <main>
      <section id="seccion1">
        <div class="columna1">
          ...
          <div class="fila3">
            <p> Our SSD storage service features the </br>
              Speed for any project you have in mind. </P>
          </div>
          <div class="fila4">
            <p> START YOUR IDEAS INSTANTLY </P>
          </div>
        </div>
        <div class="columna2">
      ...
      <section id="seccion2">
        <div class="fila1">
            <p> ADOPT YOUR CLOUD SERVER TO YOUR NEEDS  </P>
        </div>
        <div class="fila2">
          <img src="../../resources/servers.png">
        </div>
        <div class="fila3">
          <p> CONFIGURE IN WINDOWS OR LINUX ONLY CHOOSE </P>
        </div>
      </section>
      <section id="seccion3">
        <div class="fila1">
            <p> CONFIGURE NOW DO NOT EXPECT MORE </p>
        </div>
        <div class="fila2">
        <div class="grid">
          <div class="box_a">
